...
function init() {
    console.log('Welcome to the readme generator! To create your readme, you will need the following information:\n-Your project\'s title\n-A description of your project\n-Installation instructions for your project\n-Features and usage of your project\n-How others can contribute to your project\n-Tests run on your project\n-Which license you are using for your project\n-Your GitHub username\n-Your email address\nTo proceed');
    inquirer
        .prompt([
            {
                type: 'confirm',
        ...
        .then((data) => {
            if (data.continue == true) {
                ...
                console.log('Try running the program again when you are ready!');
            }
        })
}
